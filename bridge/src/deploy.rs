            ...
            let next_state = match self.state {
                ...
                DeployState::NotDeployed => {
                    ...
                    let tx_request = TransactionRequest {
                        ...
                        value: Some(self.config.txs.main_deploy.value.into()),
                ...
                DeployState::Deploying {
                    ...
                    DeployState::Deployed {
                        contract: DeployedContract::new(
                            "MainBridge".into(),
                            include_str!("../../contracts/solidity/MainBridge.sol").into(),
            ...
            let next_state = match self.state {
                ...
                DeployState::NotDeployed => {
                    ...
                    let tx_request = TransactionRequest {
                        ...
                        value: Some(self.config.txs.side_deploy.value.into()),
                        data: Some(data.clone().into()),
                        nonce: None,
                        condition: None,
                    };
                ...
                DeployState::Deploying {
                    ...
                    DeployState::Deployed {
                        contract: DeployedContract::new(
                            "SideBridge".into(),
                            include_str!("../../contracts/solidity/SideBridge.sol").into(),
